...
public final class Logger {
	 ...
	 * log path
	 */
	public static final String LOG_FILE_PATH = LOG_DIR + "crops.log";
...
//			String methodName = Thread.currentThread().getStackTrace()[STACK_COUNT]
//					.getMethodName();
//			LogCache.getInstance().write(levelString(level), tag, msg, id,
//					methodName);
//		}
